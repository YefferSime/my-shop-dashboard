        ...
        <div className='px-2 lg:px-7 pt-5 '>
            <div className='w-full p-4  bg-[#ffffff] rounded-md'>
                <div className='flex justify-between items-center pb-4'>
                    <h1 className='text-[#000000] text-xl font-semibold'>Agregar banner</h1>
                    <Link className='bg-green-500 hover:shadow-green-500/50 hover:shadow-lg text-white rounded-sm px-7 py-2 my-2 ' to='/seller/dashboard/banners'>Banners</Link>
                </div>
                {
                    !banner && <div>
                        <form onSubmit={add}>
                            ...
                            <button disabled={loader ? true : false} className='bg-green-500 hover:shadow-green-500/50 hover:shadow-lg text-white rounded-sm px-7 py-2 my-2'>
                                {
